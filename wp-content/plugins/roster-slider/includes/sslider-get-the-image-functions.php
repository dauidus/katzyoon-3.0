 ...
 * is found, call roster_sslider_display_the_image() to format it.
 *
 * @since 0.1
 ...
 */
function roster_sslider_get_the_image( $args = array() ) {
	global $post;
	...
	$args = apply_filters( 'roster_sslider_get_the_image_args', $args );
 ...
 * @return array|bool
 */
function roster_sslider_image_by_custom_field( $args = array() ) {
 ...
 * other filters are later added in the roster_sslider_display_the_image() function.
 *
 * @since 0.4
 * @param array $args
 * @return array|bool
 */
function roster_sslider_image_by_the_post_thumbnail( $args = array() ) {
 ...
 * @return array|bool
 */
function roster_sslider_image_by_attachment( $args = array() ) {
...
/**
 * Scans the post for images within the content.  Not called by default with roster_sslider_get_the_image().
 ...
 * @return array|bool
 */
function roster_sslider_image_by_scan( $args = array() ) {
 ...
 * given in an array.  Not used with roster_sslider_get_the_image() by default.
 *
 * @since 0.3
 * @param array $args
 * @return array
 */
function roster_sslider_image_by_default( $args = array() ) {
 ...
 */
function roster_sslider_display_the_image( $args = array(), $image = false ) {
...
/**
 * Get the image with a link to the post.  Use roster_sslider_get_the_image() instead.
 *
 * @since 0.1
 * @deprecated 0.3
 */
function roster_sslider_get_the_image_link( $deprecated = '', $deprecated_2 = '', $deprecated_3 = '' ) {
	roster_sslider_get_the_image();
}
